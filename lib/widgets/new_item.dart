                ...
                children: [
                  TextFormField(
                    ...
                    validator: (value) {
                      if (value == null ||
                        ...
                        return 'please enter charters between 1 to 50';
                      }
                      return null;
                    },
                    onSaved: (value) {
                    ...
                    children: [
                      ...
                      Expanded(
                        child: DropdownButtonFormField(
                            ...
                            decoration: InputDecoration(label: Text('Items')),
                            items: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                          onPressed: save_item, child: const Text('Add Item')),
                    ],
                  ),
                ],
              )),
